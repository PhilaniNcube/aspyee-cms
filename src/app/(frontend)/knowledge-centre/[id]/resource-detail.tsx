...
import { getRelatedResources, getResourceById } from '@/lib/queries'
import React from 'react'
import ResourceHero from './resource-hero'
import { Bookmark, Calendar, ChevronLeft, Download, Share2Icon, Star } from 'lucide-react'
...
const ResourceDetail = async ({ params }: { params: Promise<{ id: number }> }) => {
  ...
  async function bookmarkAction(formData: FormData) {
    ...
    await addBookmark(Number(resourceId))
  }
